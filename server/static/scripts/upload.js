var mUploadManager = function() {
    ...
    function enqueueSingle(service, fobj, callback) {
        ...
        if ( fobj instanceof File && ACCEPT_TYPES.indexOf(fobj.type)!=-1 ) {
            ...
            if (fobj instanceof File) {
                err.code = ERROR.InvalidType;
            } else {
                err.code = ERROR.NotAFile;
            }
            console.log(err);
